...
public class EmailService {
    ...
    public void sendEmail(String to, String subject, String text, boolean isHtml, File attachment){
        try{
            MimeMessage message = javaMailSender.createMimeMessage(); //tạo email
            MimeMessageHelper helper = new MimeMessageHelper(message, true); //tạo obj rỗng ghi dữ liệu vào mail
